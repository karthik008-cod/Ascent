...
extension TaskItemQueryFilter
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> deadlineIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> deadlineIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> deadlineEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'deadline',
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> deadlineGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> deadlineLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> deadlineBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> projectIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> projectIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'projectId',
      ));
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> projectIdEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'projectId',
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> projectIdGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> projectIdLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterFilterCondition> projectIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskItemQuerySortBy on QueryBuilder<TaskItem, TaskItem, QSortBy> {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByDeadlineDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByProjectId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'projectId', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> sortByProjectIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskItemQuerySortThenBy
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByDeadline() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByDeadlineDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'deadline', Sort.desc);
    });
  }
  ...
  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByProjectId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'projectId', Sort.asc);
    });
  }

  QueryBuilder<TaskItem, TaskItem, QAfterSortBy> thenByProjectIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'projectId', Sort.desc);
    });
  }
...
extension TaskItemQueryWhereDistinct
  ...
  QueryBuilder<TaskItem, TaskItem, QDistinct> distinctByDeadline() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, TaskItem, QDistinct> distinctByProjectId() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskItemQueryProperty
  ...
  QueryBuilder<TaskItem, DateTime?, QQueryOperations> deadlineProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskItem, int?, QQueryOperations> projectIdProperty() {
    return QueryBuilder.apply(this, (query) {
